class PULSE : Driver
    ...
    def get_code()
      return bytes().fromb64("")
    end
  
    def init()
      self.ulp_sleep_time = 4000
      self.reg_debounce_max_count = 77
      self.reg_init_done = 83
      self.reg_edge_count = 81
      self.reg_pulse_min = 80
      self.reg_io_number = 82
      import ULP
      self.initULP()
